...
class Hosts extends React.Component {
	...
	constructor() {
		...
		this.navigateToHost = this.navigateToHost.bind(this);
		this.onChangeHostsSort = this.onChangeHostsSort.bind(this);
		this.onChangeHostFilter = this.onChangeHostFilter.bind(this);
