						...
						<Navbar.Collapse>
							<Nav navbar>
								...
								<NavDropdown title={<span><Icon name="download" />&nbsp;&nbsp;Export</span>}
									...
									<MenuItem href="api/manifest" download={`manifest-${siteName}-${site.projectRevision}.json`}>Manifest</MenuItem>
								</NavDropdown>
							...
							<span style={{color: site.siteColor}}>
								{siteName}
								{site.environment ? <span> ({site.environment})</span> : null}
							</span>
							<br/>
							<span style={{fontSize: "80%", position: "relative", top: "-4px"}}
								  className="text-muted">{site.projectRevision}
							</span>
							</div>
						</Navbar.Collapse>
					</Navbar>
